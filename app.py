...
Based on the selected subjects generate 3 questions for the
user using the facts about the subject. 
Only reference the facts in the included list of topics.
