...
Step 3:{delimiter} Generate a quiz for the user. 
Based on the selected subjects generate 3 questions for the user using the facts about the subject.
...
tell them "I'm sorry, but I do not have information on that topic."
"""
